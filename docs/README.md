...
| [`PROJECT_REPORT.md`](./PROJECT_REPORT.md)| Academic-style write-up: problem, solution, lessons learned.    |
| [`PRESENTATION.md`](./PRESENTATION.md)    | 15-slide presentation script for the demo.                      |

Start at the project [`README.md`](../README.md) for the executive summary,
then drill down via the links above.
